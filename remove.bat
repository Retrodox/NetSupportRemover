...
IF DEFINED NETSUPPORT_VERSION (
    ...
    IF /I "%REMOVE%"=="Y" OR /I "%REMOVE%"=="YES" (
        ...
        CALL T:\TechServices-FP3\Techs\Jared\Scripts_J\NetSuppRemove\addonscripts\killtasks.bat
        IF ERRORLEVEL 1 (
		...
		:: Now, call regRun.bat
		powershell -NoProfile -ExecutionPolicy Bypass -File "T:\TechServices-FP3\Techs\Jared\Scripts_J\NetSuppRemove\addonscripts\NetSuppRemoveRegCheck.ps1"
        IF %ERRORLEVEL% NEQ 0 (
